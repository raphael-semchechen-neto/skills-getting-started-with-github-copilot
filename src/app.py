...
activities = {
    ...
    "Soccer Team": {
        "description": "Train on the field and compete in interschool soccer matches",
    ...
    "Basketball Club": {
        ...
        "max_participants": 16,
        "participants": ["nathan@mergington.edu", "sara@mergington.edu"]
    },
    "Debate Team": {
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate that a student is not signing up for the same activity twice
